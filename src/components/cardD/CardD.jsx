  ...
  return (
    <div>
      <Card className='conte me-auto mr-auto' bg='dark'>
        <Card.Img className='altimg' variant="top" src={x.imagem ? x.imagem : 'https://www.prescriptum.com.br/wp-content/uploads/2015/12/placeholder-usuario-500x500.jpg%27%7D'} />
        <Card.Body >
